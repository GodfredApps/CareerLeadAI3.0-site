...
export const INITIAL_OFFICIAL_PARTNERS: Record<string, OfficialPartnerData> = {
  emp_evi_1: {
    ...
    logo_url: 'https://skecspzevwmempzsywwp.supabase.co/storage/v1/object/public/images/partner-logos/1790340968475_t6elc.png',
  ...
  emp_aileap_2: {
    ...
    logo_url: 'https://skecspzevwmempzsywwp.supabase.co/storage/v1/object/public/images/partner-logos/aileap_official_logo.png',
  ...
  emp_diginno_3: {
    ...
    badge: 'Tech Partner',
    logo_url: 'https://skecspzevwmempzsywwp.supabase.co/storage/v1/object/public/images/partner-logos/1790337595147_t27hy.png',
